...
- ~~**Run-bar "Processing" label color**~~ — flagged in live testing 2026-08-24, but the maintainer reconsidered the same session and decided it doesn't need changing. Dropped from the backlog.
