...
1. **Run the two converter output files through a real reader** (Skyline,
   PeptideShaker, TPP or Scaffold). Open `results.sage.pin` and
   `matched_fragments.sage.tsv` from the v0.9.0 test run.
